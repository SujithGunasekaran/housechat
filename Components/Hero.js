                ...
                <div className="container-fluid">
                    {/* <div className="row">
                        <div className="col-md-12">
                            <div className="hero_my_name">Hi, I am Sujith Gunasekaran</div>
                            <div className="hero_my_info">Full Stack Developer</div>
                        </div>
                    </div> */}
                    <div className="row">
                        ...
                        <div className="col-md-6">
                            <div className="hero_middle_section_container">
                                <div className="hero_middle_left_section left">
                                    ...
                                    <div className="hero_middle_left_para">Find the best answer to your technical question, help others answer theirs</div>
                                </div>
                            </div>
                        </div>
                    </div>
